...
function AdminDashboardCard({ title, subtitle, buttonText, onClick }) {
  return (
    <div className="w-full h-40 bg-blue-200  p-5 rounded-lg  flex flex-col justify-center items-center hover:border-blue-500 hover:border-1 transition-border  ease-in-out">
      <button
